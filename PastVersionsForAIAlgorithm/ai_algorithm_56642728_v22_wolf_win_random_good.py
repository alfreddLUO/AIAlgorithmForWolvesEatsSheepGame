...
class Board:
    ...
    def calculate_sheep_scores(self, num_of_sheep_killed, shortened_distance, num_of_trapped_ways, trapped_wolf_num,num_of_to_be_killed_sheep):
        def calculate_trapped_scores(num):
            ...
            #     res += 2 * i ** 2
            return num
        return num_of_sheep_killed * (-5000) + shortened_distance * (-100) + calculate_trapped_scores(num_of_trapped_ways)*700 + trapped_wolf_num * 2000 - num_of_to_be_killed_sheep*1000
    ...
    def evaluate(self, player, gameEnds, org_board):
        if gameEnds:
            if self.winner == player:
                ...
                return -100000
        if player == 2:
            org_sheep_cnt, org_num_of_to_be_killed_sheep = org_board.check_num_of_sheep_and_num_of_to_be_killed()
            cur_sheep_cnt, cur_num_of_to_be_killed_sheep = self.check_num_of_sheep_and_num_of_to_be_killed()
            ...
            num_of_to_be_killed_sheep = cur_num_of_to_be_killed_sheep
...
def AIAlgorithm(filename, movemade):  # a showcase for random walk
    ...
    if movemade == False:
        ...
        [start_row, start_col, end_row, end_col, scores,depth] = getBestMove(board, 2, 1)
