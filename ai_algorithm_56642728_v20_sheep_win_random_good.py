...
class Board:
    ...
    def calculate_sheep_scores(self, num_of_sheep_killed, shortened_distance, num_of_trapped_ways, trapped_wolf_num,num_of_to_be_killed_sheep):
        def calculate_trapped_scores(num):
            ...
            #     res += 2 * i ** 2
            return num
        return num_of_sheep_killed * (-10000) + shortened_distance * (-100) + calculate_trapped_scores(num_of_trapped_ways)*400 + trapped_wolf_num*trapped_wolf_num * 2000 - num_of_to_be_killed_sheep*5000
